...
describe Editor::LanguagesController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "editor/languages", :action => "update", :id => 1, :lang=>'ru').should == "/ru/editor/languages/1"
    end

    it "should map #destroy" do
      route_for(:controller => "editor/languages", :action => "destroy", :id => 1, :lang=>'ru').should == "/ru/editor/languages/1"
    end
  end
