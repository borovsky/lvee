...
describe WikiPagesController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "wiki_pages", :action => "update", :id => 1, :lang=>"be").should == "/be/wiki_pages/1"
    end

    it "should map #destroy" do
      route_for(:controller => "wiki_pages", :action => "destroy", :id => 1, :lang=>"be").should == "/be/wiki_pages/1"
    end
  end
