...
describe "/news/_editor_actions" do
  before(:each) do
  ...
  describe "should render editor actions for news" do
    describe "if news not translated" do
      ...
      it "locale default" do
        ...
        render :partial => "/news/editor_actions.html.erb", :locals => {:news => @news}
        rendered.should have_selector("a", :href => translate_news_path(:parent_id => @news.id, :locale => I18n.default_locale), :content => "Translate")
      end
    end
